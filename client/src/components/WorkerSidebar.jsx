...
import { LayoutDashboard, ShoppingBag, Settings, LogOut, X } from 'lucide-react';

const WorkerSidebar = ({ activeTab, setActiveTab, logout, isOpen, setIsOpen }) => {
    const menuItems = [
        ...
        <>
            ...
            <div className={`w-64 bg-white dark:bg-gray-800 h-screen shadow-lg flex flex-col fixed left-0 top-0 z-30 transition-transform duration-300 transform 
                ...
                <div className="p-6 border-b dark:border-gray-700 flex justify-between items-center">
                    <h1 className="text-xl font-bold text-blue-600 dark:text-blue-400">QuickWash Worker</h1>
